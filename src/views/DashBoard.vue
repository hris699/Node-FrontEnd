...
export default {
  ...
  created() {
    axios.get("http://localhost:3080/posts").then((res) => {
  ...
  methods: {
    ...
    async openBlog(item) {
      this.editedIndex = this.posts.indexOf(item);
      await axios.get("http://localhost:3080/posts/").then((res) => {
    ...
    deleteItemConfirm() {
      ...
      this.closeDelete();
      axios.delete(`http://localhost:3080/posts/` + this.id).then((res) => {
        console.log(res);
      });
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        this.id = this.posts[this.editedIndex]._id;
        axios
          .put(`http://localhost:3080/posts/` + this.id, this.editedItem)
          .then((res) => {
            console.log(res);
          });
      } else {
        ...
        axios
          .post("http://localhost:3080/posts", this.editedItem)
          .then((res) => {
            console.log(res);
          });
      }
